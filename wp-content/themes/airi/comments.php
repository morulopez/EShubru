...
<div id="comments" class="comments-area">
	...
	{
		$args = array(
			'title_reply'   => esc_html__( 'Deja un comentario', 'airi' ),
			'label_submit'  => esc_html__( 'Enviar Mensaje', 'airi' ),
			...
			'fields'               => array(
				...
				'comment_field'	=>	'<div class="form-group"><textarea id="comment" rows="6" class="form-control" name="comment" placeholder="' . esc_attr__( 'Mensaje', 'airi' ) . '" aria-required="true"></textarea></div>',
			),
			'comment_field'	=>	'<div class="form-group"><textarea id="comment" rows="6" class="form-control" name="comment" placeholder="' . esc_attr__( 'Mensaje', 'airi' ) . '" aria-required="true"></textarea></div>',
		);
